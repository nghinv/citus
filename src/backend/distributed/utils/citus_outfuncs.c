...
OutTaskExecution(OUTFUNC_ARGS)
{
    ...
    WRITE_ENUM_ARRAY(taskStatusArray, count);
    WRITE_ENUM_ARRAY(transmitStatusArray, count);
    WRITE_INT_ARRAY(connectionIdArray, count);
    WRITE_INT_ARRAY(fileDescriptorArray, count);
